...
/**
 * Holds permissions callback functions
 */

class PRT_Permissions {

  public static function user_can_edit( $request ) {
    $id = isset($request['world_id'])
          ? $request['world_id']
          : isset($request['id'])
            ? $request['id']
            : 0;
  ...
  public static function user_is_admin( $request ) {
